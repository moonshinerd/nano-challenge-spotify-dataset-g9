...
# carrega o dataset (mojibake corrigido e faixas sem nome/artista removidas)
df = carregar_dataset(CAMINHO_DATASET)

# Dataframe sem faixas duplicadas (para análises que não envolvem track_genre).
# Isso evita que a mesma música (mesmo nome e artista, mas com IDs diferentes por conta de álbuns/singles) distorça as contas.
# Mapeia e concatena os gêneros e os IDs caso a música pertença a mais de um.
