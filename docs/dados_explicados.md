...
| `acousticness`     | `float` — 0 a 1              | Probabilidade/confiança de que a faixa seja acústica. Quanto mais próximo de `1`, maior a presença de características acústicas. Extritamente natural com instrumentos.                                                                 |
